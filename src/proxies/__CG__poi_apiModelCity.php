...
namespace DoctrineProxy\__CG__\poi_api\Model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class City extends \poi_api\Model\City implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'poi_api\\Model\\City' . "\0" . 'idCity', '' . "\0" . 'poi_api\\Model\\City' . "\0" . 'name'];
        }
